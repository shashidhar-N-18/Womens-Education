...
const IndustrialCourses = () => {
  useEffect(() => {
    ...
    const buttons = {
      "stitching-btn": "stitchingtutorials",
      "cooking-btn": "cookingtutorials",
    };
  ...
  return (
    <div>
      <header className="header">
        <h1>Learning Industrial Skills</h1>
        <p>Select an industrial skill and start learning!</p>
      </header>
      <div className="button-group">
        <button id="stitching-btn" className="btn">Stitching Tutorials</button>
        <button id="cooking-btn" className="btn">Cooking Tutorials</button>
      </div>
      <main>
